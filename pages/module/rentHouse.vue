...
<template>
	<view>
		...
		<swiper :current="currentTab" @change="changeTab">
			<swiper-item>
				<view class="contact">
					<view class="contact-item" v-for="(item, index) in List" :key="index" @longpress="handles">
			...
			<swiper-item>
				<ul>
					<li class="contact-item" v-for="(item, index) in expire" :key="index">
						<view class="contact-item-area">
		...
		<button class="add-button" @click.prevent="addHouse"><image src="../../../static/icon/jio@3x.png"></image>添加我的租房</button>
