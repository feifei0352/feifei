		...
		>
			...
			<view :style="{ color: color }" class="uni-navbar__header">
				<view class="uni-navbar__header-btns" @tap="onClickLeft">
					<view v-if="leftIcon.length"><uni-icon :type="leftIcon" :color="color" size="24" /></view>
				...
				<view class="uni-navbar__header-btns" @tap="onClickRight">
					<view v-if="rightIcon.length"><uni-icon :type="rightIcon" :color="color" size="24" /></view>
					<!-- 优先显示图标 -->
...
.uni-navbar {
	...
	&--shadow {
		...
		// background-color: #099c99 !important;
	}
